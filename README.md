...
- ✅ VNTG 기본 안내 메일 10종 DB 시드 마이그레이션 (`20260409120000_seed_vntg_default_email_templates.sql`, 2026.04.09)
- ✅ 구글 OAuth 로그인
...
- ✅ Candidates EXP/PIPELINE 헤더 정리 + 총 경력(개월) 표기(5y 3m) + AI Insight 이력서 인식 안정화 (2026.04.21)
- ✅ Activity Timeline @멘션·행별 스레드(답장)·인용(activity_quote) (2026.04.23) — 마이그레이션: `20260423120000_activity_timeline_threads_quotes.sql`
