...
export function TemplatesClient() {
  ...
  const handleCreateTemplate = () => {
    // TODO: 템플릿 생성 페이지가 구현되면 해당 경로로 이동
    // router.push('/templates/create');
    alert('템플릿 생성 기능은 곧 추가될 예정입니다.');
  };
      ...
      <div className="px-8 py-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">이메일 및 문서 템플릿을 관리하세요.</p>
          </div>
          <button
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">템플릿이 없습니다</h2>
          <p className="text-gray-600 mb-6">아직 생성된 템플릿이 없습니다.</p>
          <button
            onClick={handleCreateTemplate}
