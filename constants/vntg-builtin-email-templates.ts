/**
 * VNTG 채용팀 기본 안내 메일 10종 (원문 정의).
 * DB 반영: `npx tsx scripts/generate-vntg-email-templates-migration.ts` 로 SQL을 생성한 뒤 Supabase 마이그레이션을 적용합니다.
 * 치환 토큰: {{candidate.name}}, {{job.title}}, {{interview.*}} — 레거시 {{ApplicantName}} 등은 applyEmailTemplate에서 동일 값으로 매핑됩니다.
 */
export type VntgBuiltinEmailTemplate = {
  name: string;
  subject: string;
  body: string;
};

export const VNTG_BUILTIN_EMAIL_TEMPLATES: VntgBuiltinEmailTemplate[] = [
  {
    name: '면접 일정 확정 (서울)',
    subject: '[VNTG] 면접 일정 확정 안내 (서울)',
...
(차단기 밖 주황색 기둥 구역에 주차하실 경우 주차 지원이 불가하오니 참고바랍니다.)`,
  },
  {
    name: '면접 일정 확정 (포항)',
    subject: '[VNTG] 면접 일정 확정 안내 (포항)',
    body: `안녕하세요, {{candidate.name}}님
...
면접 당일 면접장소로 도착하신 후, [000-0000-0000]으로 전화주시기 바랍니다.`,
  },
  {
    name: '면접 일정 확정 (창원)',
    subject: '[VNTG] 면접 일정 확정 안내 (창원)',
    body: `안녕하세요, {{candidate.name}}님
...
면접 당일 면접장소로 도착하신 후, [010-8582-5074]으로 전화주시기 바랍니다.`,
  },
  {
    name: '면접 일정 확정 (군산)',
    subject: '[VNTG] 면접 일정 확정 안내 (군산)',
    body: `안녕하세요, {{candidate.name}}님
...
면접 당일 면접장소로 도착하신 후, [000-0000-0000]으로 전화주시기 바랍니다.`,
  ...
  {
    name: '서류합격 및 1차면접 안내 (서울)',
    subject: '[VNTG] 서류 합격 및 1차 면접 안내 (서울)',
...
면접 관련하여 문의사항 있으시면 언제든지 본 메일로 연락 부탁드립니다.`,
  },
  {
    name: '서류합격 및 1차면접 안내 (지방)',
    subject: '[VNTG] 서류 합격 및 1차 면접 안내 (지방)',
    body: `Congratulations!
...
면접 관련하여 문의사항 있으시면 언제든지 본 메일로 연락 부탁드립니다.`,
  ...
  {
    name: '1차합격 및 2차면접 안내 (서울)',
    subject: '[VNTG] 1차 합격 및 2차 면접 안내 (서울)',
    body: `Congratulations!
...
면접 관련하여 문의사항 있으시면 언제든지 본 메일로 연락 부탁드립니다.`,
  ...
  {
    name: '1차합격 및 2차면접 안내 (지방)',
    subject: '[VNTG] 1차 합격 및 인사총괄 면접 안내 (지방)',
    body: `Congratulations!
...
면접 관련하여 문의사항 있으시면 언제든지 본 메일로 연락 부탁드립니다.`,
  ...
  {
    name: '2차합격 및 3차면접 안내',
    subject: '[VNTG] 2차 합격 및 3차(대표이사) 면접 안내',
    body: `Congratulations!
