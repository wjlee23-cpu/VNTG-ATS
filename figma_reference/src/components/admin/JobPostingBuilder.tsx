...
export function JobPostingBuilder() {
  ...
  const [jobDescription, setJobDescription] = useState('We are looking for a talented Senior Product Designer to join our team...');
  
  const [stages, setStages] = useState<WorkflowStage[]>([
    { id: '1', name: 'Document Review', assignedTo: 'HR Team' },
    { id: '2', name: '1st Interview', assignedTo: 'Hiring Manager' },
    { id: '3', name: 'Technical Assessment', assignedTo: 'Tech Lead' },
    { id: '4', name: 'Final Interview', assignedTo: 'Department Head' },
  ]);
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 hover:border-[#0248FF] transition-all">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 grid grid-cols-2 gap-4">
                          {/* Stage Name */}
                          <div>
                            <label className="block text-xs text-gray-500 mb-2" style={{ fontFamily: 'Noto Sans KR, sans-serif' }}>
                              Stage Name
                            </label>
                            <input
                              type="text"
              ...
              <div className="mt-6 bg-blue-50 border border-[#0248FF] rounded-lg p-5">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm" style={{ fontFamily: 'Noto Sans KR, sans-serif' }}>
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-medium text-[#0248FF]">{stages.length * 3}-{stages.length * 5} days</span>
                  </div>
                </div>
              </div>
            </div>
